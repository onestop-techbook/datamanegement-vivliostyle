...
また、HDDやSSDも販売しているバッファローのデータ復旧サービスでの対応を見ると、
...
それぞれ、データ復旧にかかるサービスでの調査結果であるというバイアスもありますが、ハードウエアの故障も当然ながら、人的なミス、ソフトウエアの不具合、ウイルスや紛失なども相当の割合でありそうです。ソフトウエアの不具合は不可抗力である場合もありますが、ざっと半々だと考えると、データを失う確率はさらに上昇します。何度か述べているようにデバイスが故障する確率はかなり低く、デバイス故障が直接の原因であるデータ消失よりも、人為的ミスなどの方が高い割合であるという報告もあります。デバイス自体の紛失など、データ復旧サービスに持ち込まれない件もありますしね。
