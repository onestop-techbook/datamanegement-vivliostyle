...
量子化誤差は不可避なものですが、いずれにせよ、こうして、アナログデータはコンピュータで扱える形になりました。
