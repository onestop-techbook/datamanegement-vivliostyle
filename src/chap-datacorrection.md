...
```
10010011　元データ8ビット：1が4個
100100110　偶数パリティを付加：1が4個
...
```
10 01 00 11　元データ　それぞれのワードの和を計算。　2+1+0+3=6
10 01 01 11　和＝2＋1＋1＋3＝7で、元のチェックサムと異なり、どこかにエラーがある
10 00 01 11　チェックサムを同じにする「意図的な改ざん」例。ここではワードの順番の入れ替え
11 00 00 11　チェックサムを同じにする「意図的な改ざん」例。3＋0＋0＋3＝6。合計を同じにして、ワードを変更。
```
...
* 誤り訂正は「誤りを修復する」技術
* 訂正を強くするほど冗長データが増え、データ容量/通信速度にトレードオフが発生する
