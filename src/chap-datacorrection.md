...
10 01 01 11　ワードの和＝2＋1＋1＋3＝7で、元のチェックサムと異なり、どこかにエラーがある。
10 00 01 11　チェックサムを同じにする「意図的な改ざん」の例。ここではワードの順番の入れ替え。
11 00 00 11　チェックサムを同じにする「意図的な改ざん」の例。3＋0＋0＋3＝6。合計を同じにして、ワードを変更。
```
