...
それぞれの表現方式で各地の降水日を表現してみましょう。

上段では、降らなかった日に0を、雨が降った日に1を割り当てて表現します。

下段では、「雨が降った日の日付（日の部分）を2進5桁で表現します。大阪では3日に雨が降ってるので、3を取り出し、2進5桁で表現して、０００１１となります。これを並べると、次の図のようになります。
