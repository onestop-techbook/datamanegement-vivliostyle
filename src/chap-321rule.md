...
2. **2種類以上の異なる媒体に保存する**
   ...
   HDDとクラウド、NASとテープなど、リスク特性の異なる複数のメディアに保存する。
...
頻度は「失ったら困る期間」で決めるとよいでしょう。例えば「1週間分の作業を仮に失ったとして、作業で取り返しても良いか（取り返せるか）？」という観点です。

これは具体的にいうと伝票など紙のやりとりが例えばあるような業務で、電子化した伝票はシュレッダーで破棄するルールになっている場合、**破棄の頻度が「1ヶ月を経過したもの」であれば、1ヶ月までは取り返せる**　という判断が可能となります。
...
「データは必ず失われる」という前提に立ち、このルールを日常に組み込んでみませんか？
